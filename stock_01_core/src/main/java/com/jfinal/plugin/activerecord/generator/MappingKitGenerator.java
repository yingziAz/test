...
public class MappingKitGenerator {
	...
	public MappingKitGenerator(String mappingKitPackageName, String mappingKitOutputDir,String modelPkgName) {
        this.mappingKitPackageName = mappingKitPackageName;
        this.mappingKitOutputDir = mappingKitOutputDir;
    ...
    protected void genImport(StringBuilder ret,List<TableMeta> tableMetas) {
        ret.append(String.format(importTemplate));
        for (TableMeta tableMeta : tableMetas) {
            ret.append("import ").append(modelPkgName)
            .append(StrKit.notBlank(tableMeta.assignSubPkg)?("."+tableMeta.assignSubPkg):"")
            .append("."+tableMeta.modelName)
	...
	protected void genMappingMethod(List<TableMeta> tableMetas, StringBuilder ret) {
		...
		for (TableMeta tableMeta : tableMetas) {
			...
			//视图使用，非本项目可删
			if("v_v_area".equals(tableMeta.name)){
				tableMeta.primaryKey = "province_id";
			}
