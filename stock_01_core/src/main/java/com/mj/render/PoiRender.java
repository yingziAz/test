...
public class PoiRender extends Render {
	...
	private final static String CONTENT_TYPE = "application/octet-stream;charset="
			+ getEncoding();
	private List<?> data;
	...
	public void render() {
		...
		try {
			...
			PoiKit.with(data).sheetName(sheetName).headerRow(headerRow)
