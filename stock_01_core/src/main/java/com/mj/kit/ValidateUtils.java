...
public class ValidateUtils {
    ...
    private static final String MOBILE ="^1[3456789][0-9]{9}$";
     ...
     * 匹配中文字符 ^[/u0391-/uFFE5]+$
     */
    private static final String STR_CHINA="^[/u0391-/uFFE5]+$";	
    /**
     * 过滤特殊字符串正则
     * regEx="[`~!@#$%^&*()+=|{}':;',//[//].<>/?~！@#￥%……&*（）——+|{}【】‘；：”“’。，、？]"; 
     */
     ...
     */
    //private static final String STR_ENG_CHA_NUM="^[a-zA-Z0-9/u4e00-/u9fa5]+$";
    /**
     *  
     */
    /***
    ...
    public static  boolean isNumberOnly(String str) {
        return Regular(str,NUMBER_ONLY);
    }
    ...
    public static  boolean isScientific(String str){
        if(StrisNull(str))
            return false; 
        return Regular(str,ValidateUtils.SCIENTIFIC_A);
    }	
    public static void main(String[] args) {
        // TODO Auto-generated method stub
        System.out.println(ValidateUtils.isMobile("18868072797"));
    }
