 ...
 * 		
 */
public class BaseRoleResourceApi {
	...
	/**
	 * @Description:根据userId获取角色们
	 * @author lu
	 * @version 2018 年 12 月 11 日  08:48:36 
	 * @param id
	 * @return
	 */
	public List<UserRole> findByUser(String id) {
		return UserRole.dao.find("select * from sys_user_role r where r.user_id = ?",id);
	}
